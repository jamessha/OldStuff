...
class PrimitiveFunction(SchemeValue):
    ...
    def apply_step(self, args, evaluation):
    	if args.length() == 2:
    		...
    		raise('Error: Unknown length of arguments')
...
class LambdaFunction(SchemeValue):
    ...
    def apply_step(self, args, evaluation):
        ...
        evaluation.set_expr(self.body.car, self.env.make_call_frame(self.formals, args))
...
class EnvironFrame:
    ...
    def make_call_frame(self, formals, vals):
        ...
        while formals.length() > 0:
        	new_frame.define(formals.car, vals.car)
