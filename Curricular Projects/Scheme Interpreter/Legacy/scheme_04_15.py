...
class LambdaFunction(SchemeValue):
    ...
    def apply_step(self, args, evaluation):
        def replacer(args, body):
        	if body == NULL:
        		return NULL
        	elif type(body.car) == Pair:
        		return Pair(replacer(args, body.car), replacer(args, body.cdr))
        	elif body.car == self.formals.car:
        		return Pair(args.car, replacer(args, body.cdr))
        	return Pair(body.car, replacer(args, body.cdr))
        func = replacer(args, self.body.car)
