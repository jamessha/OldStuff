...
def main():
    ...
    if os.path.exists('E:\Dropbox\Projects\Quant\Data\current.xlsx'):
        os.remove('E:\Dropbox\Projects\Quant\Data\current.xlsx')
    shutil.move('E:\Dropbox\Projects\Quant\python\current.xlsx', 'E:\Dropbox\Projects\Quant\Data\current.xlsx')
