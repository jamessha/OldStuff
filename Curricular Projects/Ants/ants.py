...
class AntColony(object):
    ...
    """
    def __init__(self, strategy, hive, ant_types, create_places, food=400):
...
def apply_effect(effect, bee, duration):
    ...
    def new_method(colony):
    	nonlocal effect, bee, duration, old_actions
    	global original_action
    	if duration > 0:
    		effect(old_actions[-1])(colony)
    		duration -= 1
    	else:
