...
void sgemm(int m, int n, float *A, float *C) {
    ...
    __m128 k_vec_19;
    __m128 k_vec_20;
	#pragma omp parallel for private (i_vec_1, i_vec_2, i_vec_3, i_vec_4, j_vec_1, j_vec_2, j_vec_3, j_vec_4, j_vec_5, j_vec_6, j_vec_7, j_vec_8, j_vec_9, j_vec_10, k_vec_1, k_vec_2, k_vec_3, k_vec_4, k_vec_5, k_vec_6, k_vec_7, k_vec_8, k_vec_9, k_vec_10, k_vec_11, k_vec_12, k_vec_13, k_vec_14, k_vec_15, k_vec_16, k_vec_17, k_vec_18, k_vec_19, k_vec_20)
    for (int j = 0; j < m - m % 10; j += 10) {
        for (int i = 0; i < m - m % 8; i += 8) {
            ...
            k_vec_17 = _mm_loadu_ps(C + i + 4 + (j + 6) * m);
            k_vec_18 = _mm_loadu_ps(C + i + 4 + (j + 7) * m);
            k_vec_19 = _mm_loadu_ps(C + i + 4 + (j + 8) * m);
            k_vec_20 = _mm_loadu_ps(C + i + 4 + (j + 9) * m);
            ...
            for (int k = 0; k < n - n % 2; k += 2) {
                ...
                k_vec_11 = _mm_add_ps(k_vec_11, _mm_mul_ps(i_vec_3, j_vec_1));
                k_vec_12 = _mm_add_ps(k_vec_12, _mm_mul_ps(i_vec_3, j_vec_2));
                k_vec_13 = _mm_add_ps(k_vec_13, _mm_mul_ps(i_vec_3, j_vec_3));
                k_vec_14 = _mm_add_ps(k_vec_14, _mm_mul_ps(i_vec_3, j_vec_4));
                k_vec_15 = _mm_add_ps(k_vec_15, _mm_mul_ps(i_vec_3, j_vec_5));
                k_vec_16 = _mm_add_ps(k_vec_16, _mm_mul_ps(i_vec_3, j_vec_6));
                k_vec_17 = _mm_add_ps(k_vec_17, _mm_mul_ps(i_vec_3, j_vec_7));
                k_vec_18 = _mm_add_ps(k_vec_18, _mm_mul_ps(i_vec_3, j_vec_8));
                k_vec_19 = _mm_add_ps(k_vec_19, _mm_mul_ps(i_vec_3, j_vec_9));
                k_vec_20 = _mm_add_ps(k_vec_20, _mm_mul_ps(i_vec_3, j_vec_10));
                ...
                k_vec_11 = _mm_add_ps(k_vec_11, _mm_mul_ps(i_vec_4, j_vec_1));
                k_vec_12 = _mm_add_ps(k_vec_12, _mm_mul_ps(i_vec_4, j_vec_2));
                k_vec_13 = _mm_add_ps(k_vec_13, _mm_mul_ps(i_vec_4, j_vec_3));
                k_vec_14 = _mm_add_ps(k_vec_14, _mm_mul_ps(i_vec_4, j_vec_4));
                k_vec_15 = _mm_add_ps(k_vec_15, _mm_mul_ps(i_vec_4, j_vec_5));
                k_vec_16 = _mm_add_ps(k_vec_16, _mm_mul_ps(i_vec_4, j_vec_6));
                k_vec_17 = _mm_add_ps(k_vec_17, _mm_mul_ps(i_vec_4, j_vec_7));
                k_vec_18 = _mm_add_ps(k_vec_18, _mm_mul_ps(i_vec_4, j_vec_8));
                k_vec_19 = _mm_add_ps(k_vec_19, _mm_mul_ps(i_vec_4, j_vec_9));
                k_vec_20 = _mm_add_ps(k_vec_20, _mm_mul_ps(i_vec_4, j_vec_10));
            }
            ...
            _mm_storeu_ps((C + i + 4 + (j + 0) * m), k_vec_11);
            _mm_storeu_ps((C + i + 4 + (j + 1) * m), k_vec_12);
            _mm_storeu_ps((C + i + 4 + (j + 2) * m), k_vec_13);
            _mm_storeu_ps((C + i + 4 + (j + 3) * m), k_vec_14);
            _mm_storeu_ps((C + i + 4 + (j + 4) * m), k_vec_15);
            _mm_storeu_ps((C + i + 4 + (j + 5) * m), k_vec_16);
            _mm_storeu_ps((C + i + 4 + (j + 6) * m), k_vec_17);
            _mm_storeu_ps((C + i + 4 + (j + 7) * m), k_vec_18);
            _mm_storeu_ps((C + i + 4 + (j + 8) * m), k_vec_19);
            _mm_storeu_ps((C + i + 4 + (j + 9) * m), k_vec_20);
        }
    }
