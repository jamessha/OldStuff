...
def get_hist_info():
    ...
    f.close()
    stock_list = {}
    if os.path.exists('E:\Dropbox\Projects\Quant\data\sp500_hist_fail.txt'):
        os.remove('E:\Dropbox\Projects\Quant\data\sp500_hist_fail.txt')
    f1 = open('E:\Dropbox\Projects\Quant\data\sp500_hist_fail.txt', 'w', encoding = 'utf8')
    f2 = open('E:\Dropbox\Projects\Quant\data\sp500_curr_fail.txt', 'r', encoding = 'utf8')
...
def main():
    ...
    k = 0
    for ticker in data:
        write(s, k, f, data, ticker, 'sp500_hist.xlsx')
        s = f.create_sheet(title = 'new_sheet')
        s = f.get_sheet_by_name('new_sheet')
        k += 1
    f.save('sp500_hist.xlsx')

    if os.path.exists('E:\Dropbox\Projects\Quant\Data\sp500_hist.xlsx'):
        os.remove('E:\Dropbox\Projects\Quant\Data\sp500_hist.xlsx')
    shutil.move('E:\Dropbox\Projects\Quant\python\sp500_hist.xlsx', 'E:\Dropbox\Projects\Quant\Data\sp500_hist.xlsx')
